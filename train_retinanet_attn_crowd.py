...
import retinanet_attn_module as detector_model
...
train_loss = \
    model_path + "crowd_losses_retinanet_attn_resnet50.csv"
ckpt_model = model_path + "crowd_retinanet_attn_resnet50"
restore_flag = True
...
retinanet_model = detector_model.RetinaNetAttn(
...
print("-" * 50)
print("RetinaNet Attention Model Built with", 
